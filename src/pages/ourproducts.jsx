        ...
        <div>
            ...
            <main>
                <section className="flex flex-col justify-center">
                    ...
                    <div className="pt-30 pb-40 bg-[#fdf4e8] w-full flex flex-col justify-center items-center">
                        ...
                        <div className='max-[480px]:w-[300px] max-[600px]:w-[350px] max-[768px]:w-[400px] max-[768px]:flex-col max-[768px]:items-center mt-30 w-[1000px] flex flex-wrap flex-row justify-center items-start gap-10'>
                            ...
                            <div className='flex flex-col justify-center items-center'>
                                ...
                                <p className='max-[480px]:text-[1.3rem] max-[600px]:text-[1.4rem] max-[768px]:text-[1.6rem] mt-5 text-[1.7rem] text-gray-700'>Breads</p>
                            </div>
                            ...
                            <div className='flex flex-col justify-center items-center'>
                                ...
                                <p className='max-[480px]:text-[1.3rem] max-[600px]:text-[1.4rem] max-[768px]:text-[1.6rem] mt-5 text-[1.7rem] text-gray-700'>Cookies and Pastries</p>
                            </div>
                            ...
                            <div className='flex flex-col justify-center items-center'>
                                ...
                                <p className='max-[480px]:text-[1.3rem] max-[600px]:text-[1.4rem] max-[768px]:text-[1.6rem] mt-5 text-[1.7rem] text-gray-700'>Coffee and Drinks</p>
                            </div>
