        ...
        <div>
            ...
            <main>
                <section className=" flex flex-col justify-center">
                    ...
                    <div className="bg-[#fdf4e8] w-full flex flex-col justify-center items-center">

                        <h2 className="mt-30 max-[480px]:text-[1.7rem] max-[600px]:text-[2rem] max-[768px]:text-[2.2rem] max-[1024px]:text-[2.5rem] text-[2.8rem] text-gray-800 font-semibold">About Us</h2>

                        <hr className="max-[480px]:w-40 max-[600px]:w-50 max-[768px]:w-60 mt-[20px] text-gray-800 w-63 h-0.5" />

                        <img src={AboutBakery} alt="about shop image" className="max-[480px]:w-[300px] max-[600px]:w-[400px] max-[768px]:w-[500px] max-[1024px]:w-[550px] max-[480px]:h-[250px] max-[600px]:h-[350px] max-[768px]:h-[400px] max-[1024px]:h-[450px] mt-20 w-[900px] h-[600px] rounded-[10px] brightness-95" />

                        <p className="max-[1024px]:mx-[20px] max-[480px]:text-[0.8rem] max-[600px]:text-[0.95rem] max-[768px]:text-[1rem] max-[1024px]:text-[1.2rem] max-[1024px]:leading-10 mt-20 mb-30 mx-[300px] text-[1.25rem] text-gray-600 text-justify leading-15">Hey there, Philippines! We're Baker's Cafe, your friendly neighborhood bakery, and we're so glad you're here. Our mission is simple: to bake delicious treats and create a warm, welcoming space where everyone feels at home. We started with a tiny oven and a basic coffee maker for making our simple products while also having a big dream to be known in our community.
