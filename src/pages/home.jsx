        ...
        <div>
            ...
            <main>
                ...
                <section className="max-[1024px]:pt-[100px] max-[1024px]:pb-[100px] pt-[150px] pb-[150px] bg-[#f8efe3] flex flex-col items-center">
                    ...
                    <h2 className="max-[1024px]:mt-5 mt-30 max-[480px]:text-[1.7rem] max-[600px]:text-[1.8rem] max-[768px]:text-[1.9rem] max-[1024px]:text-[2.5rem] text-[2.8rem] text-gray-800 font-semibold">Popular</h2>

                    <hr className="max-[480px]:w-35 max-[600px]:w-40 max-[768px]:w-50 max-[1024px]:w-55 mt-[20px] text-gray-800 w-63 h-0.5" />

                    <p className="max-[1024px]:mx-7 max-[480px]:text-[0.9rem] max-[600px]:text-[1rem] max-[768px]:text-[1.05rem] max-[768px]:leading-8 mt-[30px] text-[1.1rem] text-gray-700 text-justify leading-10">Explore some of our popular and most bought products from the store.</p>
                ...
                <section className="max-[1024px]:flex-col max-[1024px]:items-center pt-[150px] pb-[150px] flex flex-row justify-center gap-15 bg-[#fff6ea]">
                    ...
                    <div className="max-[1024px]:items-center flex flex-col gap-12 justify-center">
                        <h2 className="max-[1024px]:mt-5 mt-30 max-[480px]:text-[1.3rem] max-[600px]:text-[1.5rem] max-[768px]:text-[1.8rem] max-[1024px]:text-[2.3rem] text-[2.8rem] text-gray-800 font-semibold">Our Vision</h2>
                ...
                <section className="max-[1024px]:flex-col max-[1024px]:items-center pt-[150px] pb-[150px] flex flex-row justify-center gap-15 bg-[#f8efe3]">
                    ...
                    <div className="max-[1024px]:items-center flex flex-col gap-12 justify-center">
                        <h2 className="max-[1024px]:mt-5 mt-30 max-[480px]:text-[1.3rem] max-[600px]:text-[1.5rem] max-[768px]:text-[1.8rem] max-[1024px]:text-[2.3rem] text-[2.8rem] text-gray-800 font-semibold">Service</h2>
